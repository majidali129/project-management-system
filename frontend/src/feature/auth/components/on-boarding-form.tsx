      ...
      <div className="flex-1 flex flex-col p-8 md:p-16 lg:p-20 bg-background">
        <div className="max-w-2xl space-y-8">
          <div className="space-y-2">
            <h1 className="text-2xl md:text-4xl md:leading-13 tracking-wider font-bold text-[var(--text-dark)] dark:text-[var(--text-light)]">
              How do you want to use ProjectHub?
            </h1>
            <p className="sm:text-lg text-[var(--text-dark)] dark:text-[var(--text-light)] ">
          ...
          <div className="space-y-4">
            <div
              className={` p-4 md:p-6 rounded border cursor-pointer shadow-lg bg-slate-200 dark:bg-slate-900 transition-all ${
                selectedOption === UserRole.PROJECT_MANAGER
                  ? "border-amber-500 bg-slate-100  dark:bg-slate-900/40"
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="md:text-xl font-semibold text-slate-800 dark:text-slate-200">
